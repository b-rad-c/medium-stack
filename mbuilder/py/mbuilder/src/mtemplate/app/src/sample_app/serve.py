...
# vars :: {"sample_app":"package_name", "SampOps": "ops_class_name", "sample-app": "api_prefix"}
...
app.include_router(sample_app_router, prefix=join(MSERVE_API_PREFIX, 'sample-app'))
